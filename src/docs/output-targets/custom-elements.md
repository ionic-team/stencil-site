...
See our docs on [publishing a component library](/docs/publishing) for information on setting up the library's `package.json` file and publishing to a package manager.
