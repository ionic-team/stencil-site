...
When a user updates a property, `@Watch()` will fire whatever method it's attached to and pass to that method the new value of the prop along with the old value.
