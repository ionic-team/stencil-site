      ...
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="https://stencil-worldwide.slack.com/join/shared_invite/enQtMjYwNjg5NDMzODQwLTdiNWZiNDMyMWRjZTBiMjIzMGFlOTZiZWVkNDVjNzc2ZTI5MzI2Y2VjZDgwYjczMjU3NWIxMDYzMzI2ZjY3NjM" title="Stencil slack channel">Stencil Slack</a>
              </li>
              <li>
