                ...
                <stencil-route
                  ...
                  routeRender={(props: { [key: string]: any }) => {
                    const map = {
                      ...
                      'reactive-data': 'reference/reactive-data',
                      'templating-jsx': 'reference/templating-and-jsx',
