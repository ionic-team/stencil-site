  ...
  render() {
    return (
      <div class="site-header">
        <stencil-route-link router="#router" url="/docs" class="logo-link">
        ...
        <div class="pull-right">
          ...
          <a class="svg-button" href="http://ionicworldwide.herokuapp.com" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <a href="http://github.com/ionic-team/stencil-starter" target="_blank" class="button" >
            Download
          </a>
        </div>
      </div>
