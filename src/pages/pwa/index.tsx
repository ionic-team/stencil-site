...
export default function PwaPage(): JSX.Element {
  const demos = [
    {
      title: 'Stenciljs.com',
      description: 'Yep, this site is built as a PWA!',
      imgPath: '/img/demos/demo-stenciljs',
      demoUrl: '/',
    ...
    },
    {
      ...
      imgPath: '/img/demos/demo-ionichn',
    ...
    <Layout title="PWAs">
      <main>
        <div class="measure-xl">
          <img src="/img/pwa-toolkit-logo.png" srcSet="/img/pwa-toolkit-logo.png 1x, /img/pwa-toolkit-logo@2x.png 2x" />
        ...
        <ul class="list--unstyled list--icon list--columns">
          <li>
            <app-icon name="checkmark"></app-icon> Push notifications
          </li>
          <li>
            <app-icon name="checkmark"></app-icon> Routing
          </li>
          <li>
            <app-icon name="checkmark"></app-icon> prerendering
          </li>
          <li>
            <app-icon name="checkmark"></app-icon> Update toasts
          </li>
          <li>
            <app-icon name="checkmark"></app-icon> Unit Tests
          </li>
          <li>
            <app-icon name="checkmark"></app-icon> Zero config lazy loading
          </li>
          <li>
            <app-icon name="checkmark"></app-icon> Zero config code splitting
          </li>
          <li>
            <app-icon name="checkmark"></app-icon> ES6 by default
          </li>
          <li>
            <app-icon name="checkmark"></app-icon> Selective polyfills
          </li>
          <li>
            <app-icon name="checkmark"></app-icon> Lazy image loading
          </li>
          <li>
            <app-icon name="checkmark"></app-icon> Everything needed for an add to homescreen PWA
          </li>
        </ul>
        ...
        <div class="measure-lg">
          ...
          <img
            class="screenshot"
            src="/img/pwa-lighthouse-score.png"
            srcSet="/img/pwa-lighthouse-score.png 1x, /img/pwa-lighthouse-score@2x.png 2x"
            loading="lazy"
          />
          ...
          <h4>Ionic</h4>
          <p>
            The Ionic PWA Toolkit uses an early release of Ionic 4. Ionic 4 is built completely out of web components using Stencil. This means that you can use Ionic 4 just like
            any other Stencil collection and you will be able to use any of the Ionic components with minimal to no overhead.
          </p>
          ...
          <p>
            When you run <code>npm run build</code> we automatically generate a Service Worker for you using <a href="https://workboxjs.org/">Workbox</a> that handles pre-caching
            your assets.
          ...
          <p>
            ...
            <a href="https://github.com/ionic-team/ionic-pwa-toolkit/blob/master/src/manifest.json">here</a>.
          </p>
        </div>
