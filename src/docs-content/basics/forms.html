...
export <span class="hljs-keyword">class</span> <span class="hljs-title">MyName</span> {
  ...
  handleSubmit(e) {
    ...
    <span class="hljs-comment">// send data to our backend</span>
  }
  ...
  render() {
    <span class="hljs-keyword">return</span> (
      &lt;form onSubmit={(e) =&gt; <span class="hljs-keyword">this</span>.handleSubmit(e)}&gt;
        &lt;label&gt;
          Name:
          &lt;input type=<span class="hljs-string">"text"</span> <span class="hljs-keyword">value</span>={<span class="hljs-keyword">this</span>.<span class="hljs-keyword">value</span>} onInput={(<span class="hljs-keyword">event</span>) =&gt; <span class="hljs-keyword">this</span>.handleChange(<span class="hljs-keyword">event</span>)} /&gt;
        &lt;/label&gt;
  ...
  render() {
    <span class="hljs-keyword">return</span> (
      &lt;form onSubmit={(e) =&gt; <span class="hljs-keyword">this</span>.handleSubmit(e)}&gt;
        ...
        &lt;<span class="hljs-keyword">select</span> <span class="hljs-keyword">value</span>={<span class="hljs-keyword">this</span>.selectValue} onInput={(<span class="hljs-keyword">event</span>) =&gt; <span class="hljs-keyword">this</span>.handleSelect(<span class="hljs-keyword">event</span>)}&gt;
...
</code></pre><p>As you can see, this form is a little more advanced in that it has a select input along with an email input. We also do validity checking of our email input in the <code>handleChange</code> method. As you can see, we handle the <code>select</code> element exactly how we handle text inputs.</p>
...
<p><stencil-route-link url="/docs/handling-arrays" custom="true">
