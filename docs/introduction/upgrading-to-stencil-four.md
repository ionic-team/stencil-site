...
Starting with Stencil v4.0.0, the default configuration values have changed for a few properties.
...
v4.0.0 this field is renamed to `__deprecated__cssVarsShim`. To retain the
...
support for Safari 10. For Stencil v4.0.0 this field is renamed to
...
It has been fully removed in Stencil v4.0.0 in favor of `assetsDirs`.
...
The `dist-custom-elements-bundle` has been removed starting with Stencil v4.0.0, following the [RFC process](https://github.com/ionic-team/stencil/issues/3136).
...
The flag has been removed as of Stencil v4.0.0.
...
To see which versions of Puppeteer are supported by Stencil, please see our [support matrix](../reference/support-policy.md#puppeteer)
