...
- `url`: opens a url to open a page served by the [dev server](/docs/dev-server#integrated-dev-server) (option will be ignored if `html` is set, same as calling `page.goto('...')`)
